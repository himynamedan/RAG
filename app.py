...
def get_cypher_query_from_gemini(question, neo4j_data):
    ...
    prompt_parts = [
        "You are able to generate a Cypher query from the question provided to be mapped on the Neo4j graph, based on the question and Neo4j data provided to you with the relationships. Note: Don't generate any extra text, just the Cypher query, not even comments and headings, just the code.",
        "input:" + str(question),
